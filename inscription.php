		...
		<main class="main_inscription">
			...
			<form method="post">
				<label for="login">Login</label></br>
					<input required name="login" type="text" placeholder="Ex: azerty123" maxlength="255"/><br><br>
				<label for="prenom">Prénom</label></br>
					<input required name="prenom" type="text" placeholder="Ex: Jean" maxlength="255"/><br><br>
				<label for="nom">Nom</label></br>
					<input required name="nom" type="text" placeholder="Ex: Castex" maxlength="255"/><br><br>
